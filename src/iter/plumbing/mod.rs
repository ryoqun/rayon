...
use crate::{join_context, join_context2};
...
/// llll
pub fn bridge2<I, C, II: crate::iter::ParallelIterator>(par_iter: I, consumer: C) -> C::Result
where
    I: IndexedParallelIterator,
    C: Consumer<I::Item>,
    <II as crate::iter::ParallelIterator>::Base: crossbeam_deque::CustomCollector,
{
...
/// aaaaa
pub fn bridge_producer_consumer2<P, C, II: crossbeam_deque::CustomCollector>(len: usize, producer: P, consumer: C) -> C::Result
where
    P: Producer,
    C: Consumer<P::Item>,
{
