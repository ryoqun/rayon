...
#[must_use = "iterator adaptors are lazy and do nothing unless consumed"]
#[derive(Debug, Clone)]
pub struct InstallType<I: ParallelIterator, CC: CustomCollector> {
    base: I,
...
impl<I: ParallelIterator, E> MMM for Map<I, E> {}
...
impl<I: ParallelIterator<Base = G> + MMM, CC: CustomCollector, G: InstallType<CC>/*, G: WithInstallType<CC>*/> WithInstallType<CC> for I {
}
